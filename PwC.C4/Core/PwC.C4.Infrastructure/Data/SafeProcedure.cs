...
namespace PwC.C4.Infrastructure.Data
{
    ...
    public class SafeProcedure
    {
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public static T ExecuteAndGetInstance<T>(Database database, string procedureName, RecordMapper<T> recordMapper, params SqlParameter[][] parameters) where T : new()
        {
            T objectInstance = new T();
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public static List<T> ExecuteAndGetInstanceList<T>(Database database, string procedureName, RecordMapper<T> recordMapper, SqlParameter[] parameters) where T : new()
        {
            List<T> instanceList = new List<T>();
            ExecuteAndHydrateInstanceList(instanceList, database, procedureName, recordMapper, parameters);
            return instanceList;
        ...
        [Obsolete("Paging in memory...")]
        public static List<T> ExecuteAndGetInstanceList<T>(Database database, string procedureName,int page,int pagesize, RecordMapper<T> recordMapper, SqlParameter[] parameters) where T : new()
        {
            List<T> instanceList = new List<T>();
        ...
        public static List<T> ExecuteAndMetadata<T>(Database database, string procedureName,
            RecordMapper<T> recordMapper, SqlParameter[] parameters)
        {
            try
            {
                var list = new List<T>();
                using (IRecordSet reader = Procedure.Execute(database, procedureName, parameters))
                {
                    while (reader.Read())
                    {
                        ...
                        dynamic objectInstance = Activator.CreateInstance(typeof(T));
                        recordMapper(reader, objectInstance);
        ...
        public static void ExecuteAndHydrateInstanceList<T>(List<T> instanceList, Database database, string procedureName, RecordMapper<T> recordMapper, SqlParameter[] parameters) where T : new()
        {
            try
            {
                if (log.IsDebugEnabled)
        ...
        [Obsolete("Paging in memory")]
        public static void ExecuteAndHydrateInstanceList<T>(List<T> instanceList, Database database, string procedureName, int page, int pagesize, RecordMapper<T> recordMapper, SqlParameter[] parameters) where T : new()
        {
            try
            {
                if (log.IsDebugEnabled)
