...
(function ($) {
    $.fn.EasyTree = function (options) {
        var defaults = {
            ...
            addable: false,
            i18n: {
                deleteNull: 'Please select items to delete.',
                deleteConfirmation: 'Are you sure you want to delete operation?',
                confirmButtonLabel: 'Confirm',
                editNull: 'Please select item to edit.',
                editMultiple: 'Can\'t multiple edit',
                addMultiple: 'Can\'t multiple add',
